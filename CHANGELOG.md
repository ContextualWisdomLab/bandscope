...
- Tier-1 real-audio harmony acceptance: decode a deterministic C-major triad WAV through production intake bounds and publish a section-level accuracy manifest (issue #770).
