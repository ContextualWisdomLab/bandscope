...
- Issue #36: Added policy-constrained YouTube import with local fallback
...
- 신규 UI 요소의 동작을 검증하는 단위 테스트를 추가했습니다 (`apps/desktop/src/features/chords/index.test.tsx`, `apps/desktop/src/features/ranges/index.test.tsx`).
