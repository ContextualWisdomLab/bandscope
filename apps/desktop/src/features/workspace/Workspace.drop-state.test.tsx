...
function analyzedSongWithDropPlan(): RehearsalSong {
...
describe("Workspace drop state authority", () => {
  beforeEach(() => {
  ...
  it("keeps an opened drop armed after an immutable practice-progress update", () => {
    const song = analyzedSongWithDropPlan();
