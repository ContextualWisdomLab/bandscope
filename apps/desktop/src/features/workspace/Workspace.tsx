            ...
            {activeRole && (
              <div className="mb-4 rounded-2xl border border-emerald-300/20 bg-emerald-300/[0.06] p-4">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <Button type="button" disabled title={t("comingSoon")} variant="outline" className="min-h-11 cursor-not-allowed border-white/10 bg-white/5 text-slate-400">Play stem</Button>
                  <Button type="button" disabled title={t("comingSoon")} variant="outline" className="min-h-11 cursor-not-allowed border-white/10 bg-white/5 text-slate-400">Loop section</Button>
                  <Button type="button" disabled title={t("comingSoon")} variant="outline" className="min-h-11 cursor-not-allowed border-white/10 bg-white/5 text-slate-400">Solo / mute others</Button>
                  <Button
                    type="button"
