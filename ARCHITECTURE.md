...
- Core rehearsal artifacts should include:
  ...
  - playable ranges and density or overlap warnings, with the ready workspace naming tonight's first span, the next instrument check, and the first tacet so the band does not fill a rest
