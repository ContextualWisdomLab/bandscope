...
/** Return a localized section form when it is canonical; preserve unknown owned labels literally. */
export function translateSectionFormLabel(locale: Locale, label: string): string {
  const labels = sectionFormLabels[locale] as Readonly<Record<string, string>>;
