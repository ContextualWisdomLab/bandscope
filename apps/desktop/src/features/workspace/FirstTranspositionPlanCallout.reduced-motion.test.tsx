...
describe("FirstTranspositionPlanCallout reduced motion", () => {
  afterEach(() => {
    vi.unstubAllGlobals();
  });
  ...
  it("scrolls immediately when the operating system requests reduced motion", () => {
    ...
    grid.setAttribute("data-workspace-song-structure-grid", "");
    ...
    render(<FirstTranspositionPlanCallout song={createDemoRehearsalSong()} />);
