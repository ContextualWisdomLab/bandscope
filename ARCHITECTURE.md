...
- Core rehearsal artifacts should include:
  ...
  - playable ranges and density or overlap warnings, with the ready workspace naming tonight's first span, tonight's first D.C. al Coda to return to the beginning and take the coda jump, and the next instrument check
