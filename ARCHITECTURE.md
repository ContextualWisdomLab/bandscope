...
- Core rehearsal artifacts should include:
  ...
  - groove and timing cues relevant to locking the band together, with the ready workspace naming tonight's first click and the BPM to set before the opening section
