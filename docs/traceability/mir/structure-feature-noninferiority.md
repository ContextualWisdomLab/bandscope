...
5. Preserve the registration, result receipt, corpus/annotation hashes, exact source commit, lock hash, aggregation implementation identity, and uncertainty procedure together. A production feature switch requires this evidence plus normal code review and protected-head checks.
