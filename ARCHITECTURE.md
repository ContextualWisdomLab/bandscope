...
- Design-system Figma page/root identities live in `docs/design-system/figma-handoff-inventory.json`. `scripts/checks/verify_figma_handoff.py` reports drift without calling Figma.
