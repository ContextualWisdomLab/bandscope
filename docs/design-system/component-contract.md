...
- Ready `Workspace` names tonight's first playable range and tonight's first count-out so the map enables the next rehearsal action without opening files or export paths.
