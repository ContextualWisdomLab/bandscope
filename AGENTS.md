...
- Name tonight's first blocked assignment with the assignee, the uniquely named labeled section and time, and the holding part when it is corroborated, so the next action is obvious. Do not invent a blocked job from todo, in-progress, or ready assignments, comments, or approvals.
