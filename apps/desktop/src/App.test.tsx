...
describe("App", () => {
  ...
  it("summarizes confidence from the lowest-confidence loaded section and breaks early when low confidence is found", async () => {
    const loadedProject = succeededResult().result;
    loadedProject.sections.push({
      ...loadedProject.sections[0],
      id: "chorus-1",
      label: "chorus",
      confidence: { level: "low", source: "model", notes: "The chorus form is unclear." }
    });
  ...
  it("stops confidence scanning after a low-confidence section", async () => {
    const loadedProject = succeededResult().result;
    loadedProject.sections.push({
      ...loadedProject.sections[0],
      id: "chorus-1",
