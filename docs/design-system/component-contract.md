...
| Section Roadmap Card | https://www.figma.com/design/zthWmqfNKUgJBECvv002Qk/Bandscope-Design-System-v1?node-id=19-402 | `apps/desktop/src/features/workspace/SectionRoadmap.tsx` | Use `song`, `activeRole`, optional `onSongUpdate`, and optional `loopedSectionId`; the first or looped card counts in at the analyzed tempo. Avoid rebuilding its internal card layout. |
