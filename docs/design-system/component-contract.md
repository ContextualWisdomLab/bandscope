...
| First Entrance Callout | workspace next-action pattern | `apps/desktop/src/features/workspace/FirstEntranceCallout.tsx` | Name the first hearable part, section, and start time; keep the Hear button visible. |
