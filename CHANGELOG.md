...
- Name tonight's first harmonic explanation in the mounted rehearsal workspace so the room can play from the owned harmony reason before rehearsal; the Open action moves to the matching rendered map section, while inherited or accessor-backed runtime metadata remains guidance-only instead of becoming navigation authority.
