...
## Project overview
- BandScope is a local-first desktop app for rehearsal prep: a practical song view with likely harmony by section and by instrument or vocal role, form and groove cues, stems, playable ranges, tonight's first segno for the return-together, simplification guidance, transposition or setup cues, part-overlap cues, visible confidence, and rehearsal priorities.
