...
- Name tonight's first overlap with the warned part when an active role is corroborated, the owned clash text, the labeled section, and the time so the next action is obvious.
