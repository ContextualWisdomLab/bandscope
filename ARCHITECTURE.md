...
- Workspace and player copy for tonight's first labeled chorus must name the holding part when corroborated, the labeled lift, and the time so the next action is obvious.
