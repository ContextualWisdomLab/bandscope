...
- Name tonight's first transition with the changing part when an active role is corroborated, the owned transition cue, the labeled section, and the time so the next action is obvious.
