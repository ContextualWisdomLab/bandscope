...
For the active #779 branch, no success claim is valid until the complete jsdom 30 lock is generated by npm `10.9.9`, reviewed as a whole, and all required exact-head CI, security, supply-chain, coverage, build, release, and independent-review gates pass on an unchanged head.
