...
- Keep unexpected groove, stop-time, and shared-hit dependency failures out of routine log payloads while retaining bounded operation and exception-class diagnostics.
