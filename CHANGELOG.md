...
- Raised npm HIGH-severity dependency baseline: `pdfjs-dist` 6.2.108 (GHSA-hq66-cqwq-w95j / CVE-2026-16633), `nanoid` 3.3.18 (GHSA-2v37-7h3g-55p8), `undici` 7.29.0 (downstream response desynchronization, cache-directive, CRLF, and cookie injection advisories).
