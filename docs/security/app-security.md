...
- Keep `docs/doctoring/subprocess-containment.md` synchronized with this boundary and the executable regressions; process-group control is not sandbox/container isolation and does not replace whole-process resource measurement.
