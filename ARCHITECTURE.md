...
- Core rehearsal artifacts should include:
  ...
  - playable ranges and density or overlap warnings, with the ready workspace naming tonight's first span, tonight's first D.S. al Coda to return to the segno and take the coda jump, and the next instrument check
