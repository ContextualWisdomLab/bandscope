...
- Optional-cache failures including malformed ZIP/NPY state, invalid or timeline-inconsistent persisted duration, allocator exhaustion, short snapshot copy, and unsupported representation become cache misses rather than authoritative rehearsal results.
