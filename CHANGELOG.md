...
- Preserve GrooveMap's ten-second timeline floor and predecessor numeric semantics while computing larger transcription bounds with a single allocation-free loop.
