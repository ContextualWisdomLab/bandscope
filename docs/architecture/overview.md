...
- role ranges, overlap warnings, and simplification guidance, with the ready workspace naming tonight's first span and offering controls that find the section on the timeline and the exact part on the section roadmap
