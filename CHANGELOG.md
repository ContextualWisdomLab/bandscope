...
- Keep local tempo results compatible with the native status contract, allow bounded tempo analysis to finish after stem separation, and key final, feature, and stem-work caches by source content rather than file size alone.
