...
MITRE. (n.d.). *CWE-22: Improper limitation of a pathname to a restricted directory ('Path Traversal')* (CWE 4.20). Retrieved September 19, 2026, from https://cwe.mitre.org/data/definitions/22.html

The Rust Project. (n.d.). *Component in std::path*. Retrieved September 19, 2026, from https://doc.rust-lang.org/std/path/enum.Component.html
