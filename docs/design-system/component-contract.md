...
| First Lyric Cue Callout | workspace next-action pattern | `apps/desktop/src/features/workspace/FirstLyricCueCallout.tsx` | Name the first lyric, part, section, and start time; keep the Hear button visible. |
