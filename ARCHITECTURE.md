...
- Core rehearsal artifacts should include:
  ...
  - playable ranges and density or overlap warnings, with the ready workspace naming tonight's first span, the next instrument check, and the first last-line breath so the band finishes the phrase together
