...
| Trusted distribution | Issue #960; active release-identity lane PR #1126 | #1126 now applies semantic multiword naming across its new release-identity production and test surfaces on exact head `b0d5ecbf18f20842b88879c74fdadd7208476ad7`; Windows signing, macOS signing/notarization, checksums, SBOM/provenance, signature-verified updater, staged rollout, rollback/repair, and complete version-identity parity remain incomplete as one integrated protected-head receipt |
