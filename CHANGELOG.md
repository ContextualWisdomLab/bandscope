...
- The ready workspace can open tonight's first notes or range on the groove map from the selected part, honors the user's reduced-motion preference for that navigation, and no longer leaves `Transcribe` as a dead end.
