...
| Trusted distribution | Issue #960; active release-identity lane PR #1126 | Release identity now has an active fail-closed implementation lane, while Windows signing, macOS signing/notarization, checksums, SBOM/provenance, signature-verified updater, staged rollout, rollback/repair, and complete version-identity parity remain incomplete as one integrated protected-head receipt |
