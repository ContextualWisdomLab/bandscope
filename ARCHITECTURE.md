...
- Core rehearsal artifacts should include:
  ...
  - playable ranges and density or overlap warnings, with the ready workspace naming tonight's first span and tonight's first leftover sit-out after a partial return
