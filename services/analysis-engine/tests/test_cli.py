...
def test_cli_main_temporal_analyzer_mock_success(
    ...
    """Ensure local audio temporal analysis runs once through orchestration."""
    ...
    monkeypatch.setattr(
        ...
        lambda _request, _source_fingerprint=None: None,
    )
    monkeypatch.setattr(
    ...
    assert temporal_calls == [str(audio_path)]
