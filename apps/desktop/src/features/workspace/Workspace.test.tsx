...
describe("Workspace", () => {
  ...
  it("names tonight's first setup note as workspace navigation", () => {
    setNavigatorLanguage("en-US");
    const song = createDemoRehearsalSong();
    ...
    expect(screen.getAllByText("Keep the attack short so the verse breathes.").length).toBeGreaterThan(0);
