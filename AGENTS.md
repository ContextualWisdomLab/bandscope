...
- After a part is selected, the transcribe control must open tonight's first notes or range on the groove map. Do not leave `Transcribe` as a no-op or "coming soon", and do not invent a new MIR extractor.
