...
- Workspace and player copy for tonight's first labeled outro must name the holding part when corroborated, the labeled ending, and the time so the next action is obvious.
