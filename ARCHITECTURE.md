...
- Workspace and player copy for tonight's first stop must name the holding part when corroborated, the labeled cut, and the time so the next action is obvious.
