...
describe("FirstVampPlanCallout workspace scope", () => {
    ...
    const { container } = render(
      <>
        <div data-testid="workspace-one">
          <FirstVampPlanCallout song={firstSong} />
          <div id="workspace-song-structure-grid" data-testid="song-structure-grid">
            <div data-section-index="0" />
          </div>
        </div>
        <div data-testid="workspace-two">
          <FirstVampPlanCallout song={secondSong} />
          <div id="workspace-song-structure-grid" data-testid="song-structure-grid">
            <div data-section-index="0" />
          </div>
        </div>
