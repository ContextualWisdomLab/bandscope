...
|---:|---|---|---|---|
| P0 | Trusted distribution and update | Version `0.1.0`; release workflow is principally validation/preflight; no complete signed/notarized updater and rollback evidence | Buyers cannot establish publisher trust or safely update/repair | [#960](https://github.com/ContextualWisdomLab/bandscope/issues/960) |
...
| P1 | Design and accessibility parity | Storybook work is open. The saved Figma file claims 28 pages but currently exposes two top-level pages; its footer cites `0.1.3`, while repository/runtime metadata cites `0.1.0` | Design status can be mistaken for shipped behavior; assistive-technology acceptance is incomplete | [#965](https://github.com/ContextualWisdomLab/bandscope/issues/965) |
