...
- Core rehearsal artifacts should include:
  ...
  - playable ranges and density or overlap warnings, with the ready workspace naming tonight's first span, tonight's first Da Capo to go back to the beginning, and the next instrument check
