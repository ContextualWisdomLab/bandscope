...
- Preserved first-occurrence chart-export ordering while replacing quadratic list de-duplication with semantically named, dictionary-backed expected-linear processing.
