...
describe("FirstPartHandoffCallout Korean role copy", () => {
  ...
  it("keeps vowel-ending dynamic role names particle-safe before and after the handoff action", () => {
    ...
    seed.partGraph = [
      ...
      { role_id: "vocal", is_active: true, handoff_to: [], handoff_from: ["piano"] }
    ];
    ...
    expect(screen.getByText("0:10 벌스에서 피아노 파트가 보컬 파트로 넘깁니다.")).toBeTruthy();
