...
- Name tonight's first stop on the workspace and player so the room can hold the cut; the workspace action opens the matching map section, while the player exposes a Hear action only when its owning playback surface supplies a seek callback.
