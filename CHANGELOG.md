...
- Recorded live Figma page and root IDs for Cover plus contract pages 28-34, and added an offline handoff drift check so Cover-only MCP listings cannot silently retire the rehearsal contract.
