...
- Name tonight's first playable range on the ready rehearsal map, offer Find {section} at {clock} on the timeline so the player can locate that span, and tell the player to check that span on their instrument before the section.
