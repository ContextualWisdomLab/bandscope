...
- Workspace and player copy for tonight's first labeled intro must name the holding part when corroborated, the labeled start, and the time so the next action is obvious.
