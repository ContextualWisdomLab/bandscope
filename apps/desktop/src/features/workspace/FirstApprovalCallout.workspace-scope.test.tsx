...
describe("FirstApprovalCallout workspace scope", () => {
  it("opens the song-structure renderer owned by the current workspace", () => {
    ...
    const actions = screen.getAllByRole("button", { name: "Open verse approval at 0:10" });
