...
describe("naruon rehearsal handoff contract", () => {
  ...
  it.each([
    ["root contains an unexpected field", (value: any) => { value.extra = true; }],
    ...
    ["source contains an unexpected field", (value: any) => { value.source.extra = true; }],
    ...
    ["normGroup contains an unexpected field", (value: any) => { value.normGroup.extra = true; }],
    ...
    ["event contains an unexpected field", (value: any) => { value.event.extra = true; }],
    ...
    ["commitment contains an unexpected field", (value: any) => { value.commitment.extra = true; }],
    ...
    ["provenance contains an unexpected field", (value: any) => { value.provenance.extra = true; }],
    ...
    ["evidence[0] contains an unexpected field", (value: any) => { value.provenance.evidence[0].extra = true; }],
