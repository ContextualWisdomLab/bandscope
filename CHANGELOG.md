...
- Import a bounded, validated BandScope metadata-handoff JSON file and reuse its focused rehearsal roles only after the recipient explicitly selects local audio for reanalysis (#739).
