...
// Performance: Hoist static decoration array to avoid O(N) allocation and React node recreation on every render
...
// Performance: Hoist static decoration array to avoid O(N) allocation and React node recreation on every render
const LOCAL_FIRST_DECORATIVE_BARS = Array.from({ length: 34 }).map((_, index) => (
  <span
    key={index}
