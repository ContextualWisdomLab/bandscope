...
- Ready `Workspace` names tonight's first playable range and tonight's first tacet so the map enables the next rehearsal action without opening files or export paths.
