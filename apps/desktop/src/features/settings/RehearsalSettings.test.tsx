...
describe("RehearsalSettings", () => {
  ...
  it("names admitted formats and asks for a supported file before a song is ready", () => {
    ...
    render(<RehearsalSettings disabled={false} songReady={false} onChooseAudio={onChooseAudio} onOpenMap={onOpenMap} />);
  ...
  it("opens tonight's rehearsal map once a song is ready", () => {
    ...
    const onOpenMap = vi.fn();
    setNavigatorLanguage("en-US");
    render(<RehearsalSettings disabled={false} songReady={true} onChooseAudio={onChooseAudio} onOpenMap={onOpenMap} />);
  ...
  it("keeps Korean copy on the same next actions", () => {
    ...
    render(<RehearsalSettings disabled={false} songReady={false} onChooseAudio={onChooseAudio} onOpenMap={() => undefined} />);
  ...
  it("disables the choose-file action while the app is busy", () => {
    render(<RehearsalSettings disabled={true} songReady={false} onChooseAudio={() => undefined} onOpenMap={() => undefined} />);
