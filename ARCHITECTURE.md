...
- Core rehearsal artifacts should include:
  ...
  - playable ranges and density or overlap warnings, with the ready workspace naming tonight's first span, tonight's first D.S. al Fine to return to the segno and end at Fine, and the next instrument check
