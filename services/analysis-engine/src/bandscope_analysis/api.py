...
class RehearsalToCodaPayload(TypedDict):
    """Typed trusted To Coda payload nested inside rehearsal songs."""
...
class RehearsalSong(TypedDict):
    ...
    toCoda: NotRequired[RehearsalToCodaPayload]
