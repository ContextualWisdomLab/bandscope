...
def test_stem_separation_worker_maps_safe_error_kinds() -> None:
    ...
    cases = [
        (FileNotFoundError("missing"), "file_not_found", "Audio source file could not be found."),
        (ValueError("bad media"), "value_error", "An invalid audio parameter was provided."),
        (RuntimeError("oom"), "runtime_error", "An internal engine error occurred."),
        (Exception("unexpected"), "runtime_error", "An internal engine error occurred."),
    ]
    ...
    assert fake_queue.items == [("runtime_error", "An internal engine error occurred.")]
