...
def test_cli_passes_empty_local_source_to_job_runner(monkeypatch: pytest.MonkeyPatch) -> None:
    """Pass local requests through without a duplicate temporal probe."""
    payload = {
