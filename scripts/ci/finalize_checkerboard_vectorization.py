...
@pytest.mark.parametrize(
    ...
    [(1, 1), (3, 3), (4, 3), (4, 4), (17, 4), (48, 8), (65, 64), (96, 15)],
)
...
'''
    return replace_once(text, old, new, "independent checkerboard oracle")


def main() -> int:
    """Apply every reviewed change only after all source fragments match."""
