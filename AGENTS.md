...
- Name tonight's first pending approval with the owner, the owned scope, and the uniquely named labeled section and time so the next action is obvious. Do not invent a sign-off from assignments, comments, or already-approved scopes.
