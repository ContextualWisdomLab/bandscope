...
- Workspace and player copy for tonight's first labeled handoff must name the holding part when corroborated, the labeled pass, and the time so the next action is obvious.
