...
- Name tonight's first labeled handoff with the holding part when an active role is corroborated, the labeled pass, and the time so the next action is obvious.
