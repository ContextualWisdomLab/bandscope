...
describe("resolveFirstFadePlan proxy authority", () => {
  it("does not read inherited or Proxy-substituted fadePlan as rehearsal copy", () => {
    ...
    const hostile = new Proxy(vocal, {
      get(_target, property) {
        if (property === "fadePlan") {
          return "Fade this part; let the next downbeat land quieter.";
        }
