...
## 2026-07-15 - Avoid Array.every for massive buffers
**Learning:** Using Array.prototype.every() on massive arrays like PDF byte buffers incurs severe main-thread blocking due to massive O(N) callback overhead.
**Action:** Use a standard for-loop with an early break to validate massive arrays for measurable performance gains without massive overhead.
