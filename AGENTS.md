...
## Project overview
- BandScope is a local-first desktop app for rehearsal prep: a practical song view with likely harmony by section and by instrument or vocal role, form and groove cues, stems, playable ranges, leftover last-dropout remaining return cues after leftover last-dropout remaining, simplification guidance, transposition or setup cues, part-overlap cues, visible confidence, and rehearsal priorities.
