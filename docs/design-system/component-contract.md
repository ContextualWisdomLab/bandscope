...
- Ready `Workspace` names tonight's first playable range and tonight's first score check so the map enables the next rehearsal action without opening PDF bytes.
