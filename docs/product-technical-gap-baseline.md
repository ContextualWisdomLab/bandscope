...
| Accessibility/design parity | Issue #965 | WCAG 2.2 AA, keyboard/screen-reader parity, KO/EN/JA/ZH/VI/ES/DE/FR expansion, exact-value alternatives and current-head UI evidence remain incomplete; #1160's EN/KO playback-source states are an active child slice, not completion of this owner |
