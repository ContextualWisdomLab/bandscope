...
function ConfidenceMetric({ song }: { song: RehearsalSong | null }) {
  ...
  // Performance: Use a for...of loop with an early break to short-circuit the minimum search
  // when the absolute lowest bound ('low') is found, avoiding an unconditional O(N) array traversal.
