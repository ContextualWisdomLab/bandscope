...
- The ready workspace can count in tonight's first or looped section on the Section Roadmap card at the analyzed tempo, after the map loop is selected, instead of leaving "Count in on that card" as a dead instruction.
