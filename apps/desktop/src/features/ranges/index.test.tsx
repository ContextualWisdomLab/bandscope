...
describe("RangesFeature", () => {
  ...
  it("names tonight's first playable span and the next instrument check", () => {
    ...
    expect(screen.getByTestId("range-card-bass-guitar")).toHaveTextContent("C#2 — E3");
    expect(screen.getByTestId("range-card-bass-guitar")).toHaveTextContent(
  ...
  it("rejects inverted spans instead of calling them playable", () => {
    ...
    const card = screen.getByTestId("range-card-bass-guitar");
